...
from .views import PostListView, PostDetailView, PostCreateView, PostUpdateView, PostDeleteView, PostLoginView, PostLogoutView
from . import views
...
urlpatterns = [
    ...
    path('logout_page/', PostLogoutView.as_view(), name='logout_page'),
